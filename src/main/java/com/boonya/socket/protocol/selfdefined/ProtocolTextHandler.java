...
public class ProtocolTextHandler implements Handler {
	...
	@Override
	public byte[] encode(Protocol msg) throws IOException {
	...
	@Override
	public Protocol decode(byte[] input) throws IOException {
		...
		return new Protocol(isResponse, isInquiry, candidateID, voteCount);
	}
